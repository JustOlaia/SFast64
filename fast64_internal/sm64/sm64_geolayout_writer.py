...
def processMesh(
    ...
    if useSwitchNode or addRooms:  # Specific empty types
        ...
        elif obj.geo_cmd_static == "MetalComposerBone":
            if not zeroRotation or not zeroScaleChange:
                # translate/rotate -> scale -> MetalComposerBone
                node = MetalComposerBoneNode(int(obj.draw_layer_static), True, mathutils.Vector((0, 0, 0)))
                ...
                node = MetalComposerBoneNode(int(obj.draw_layer_static), True, translate)
...
def processBone(
    ...
    if bone.geo_cmd in animatableBoneTypes:
        ...
        elif bone.geo_cmd == "MetalComposerBone":
            if not zeroRotation:
                node = MetalComposerBoneNode(int(bone.draw_layer), hasDL, mathutils.Vector((0, 0, 0)))
                ...
                node = MetalComposerBoneNode(int(bone.draw_layer), hasDL, translate)
                lastTranslateName = boneName
