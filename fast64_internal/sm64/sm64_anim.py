...
def exportAnimationC(armatureObj, loopAnim, dirPath, dirName, animID, groupName, customExport, headerType, levelName):
                ...
                if not context.scene.animCustomExport:
                    ...
                    if context.scene.animJsonExport:
                        exportAnimationJSON(
                            ...
                            context.scene.animJsonName,
                            context.scene.animJsonAuthor,
                            context.scene.animJsonExtraBone)
                    ...
                    exportAnimationC(
                        ...
                        bpy.context.scene.animExportID,
...
def sm64_anim_register():
    ...
    bpy.types.Scene.animExportPath = bpy.props.StringProperty(name="Folder Name", subtype="FILE_PATH")
    bpy.types.Scene.animExportID = bpy.props.StringProperty(name = 'ID', default = 'anim_C2')
    ...
    bpy.types.Scene.animJsonExport = bpy.props.BoolProperty(name = 'Export to JSON')
    bpy.types.Scene.animJsonPath = bpy.props.StringProperty(name = 'JSON Path', subtype = 'FILE_PATH')
    bpy.types.Scene.animJsonName = bpy.props.StringProperty(name = 'Name', default = 'Custom Animation')
    bpy.types.Scene.animJsonAuthor = bpy.props.StringProperty(name = 'Author', default = 'sm64rise')
    bpy.types.Scene.animJsonExtraBone = bpy.props.BoolProperty(name = 'Extra MComp+ Bone')
